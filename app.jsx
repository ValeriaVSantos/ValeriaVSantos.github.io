    ...
    <Reveal delay={2}>
      <div className="portrait-wrap">
        ...
        <div className="portrait">
          <img src="assets/valeria.jpg" alt="Portrait of Valéria Vieira Santos" />
        </div>
        ...
        <div className="portrait-badge">
          ...
          <span>Available · Spring 2026 collaborations</span>
        </div>
      </div>
    </Reveal>);
          ...
          <Reveal delay={1}>
            <div className="about-prose">
              <p>
                ...
                Roda Viva Corpus to audit overconfidence in GPT-4 and Sabiá-2 — correlating the suppression of
  ...
  return (
    <section id="publications">
      <div className="container">
        ...
        <FilteredList items={window.SITE.publications} allTags={window.SITE.pubTags.slice(1)} />
      </div>
    </section>);
    ...
    <section id="talks" style={{ paddingTop: 0 }}>
      <div className="container">
        ...
        <div style={{ marginTop: 32 }}>
          <FilteredList items={window.SITE.talks} allTags={window.SITE.pubTags.slice(1)} />
        </div>
      </div>
    </section>);
...
function Experience() {
  ...
  { when: '2026 – present', role: 'Posgraduate Coursework · Applied Statistics', org: '<em>Anhaguera</em>', desc: 'Quantitative methods and statistical modeling for NLP.' },
  ...
  return (
    <footer className="footer container">
      <div className="signature">
        <span>© 2026 Valéria Vieira Santos</span>
        <span>—</span>
