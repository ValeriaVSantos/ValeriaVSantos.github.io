      ...
      <div className="viz-shell">
        <div className="card viz-card">
          <div className="viz-head">
            <div className="viz-title">Calibration Under Sanitization <span className="viz-illustrative-badge">illustrative example</span></div>
          ...
          <div style={{display:'flex', justifyContent:'space-between', fontFamily:'Geist Mono, monospace', fontSize:10, color:'var(--text-3)', marginTop:8, letterSpacing:'0.08em'}}>
            <span>points here are illustrative dialogue examples · hover ↺ explore · click ⌖ pin</span>
          </div>
        </div>
        ...
        <div className="viz-side">
          ...
          <div className="card viz-metric">
            <span className="vm-lbl">Expected Calibration Error (ECE)</span>
            <span className="vm-val">41.95 <span>→ 41.14 sanitized</span></span>
            <span className="vm-sub">faithful (Layer A) vs. sanitized (Layer B) transcripts · n=344 turns, 3 interviews</span>
          </div>

          <div className="card viz-metric">
            <span className="vm-lbl">Overconfidence Error</span>
            <span className="vm-val">4.29 <span>→ 3.31 sanitized</span></span>
            <span className="vm-sub">Wilcoxon W=10988.50, p=0.0023</span>
          </div>

          <div className="card viz-metric">
            <span className="vm-lbl">Spearman ρ (confidence–correctness)</span>
            <span className="vm-val">−0.49 <span>vs. −0.43 sanitized</span></span>
            <span className="vm-sub">faithful vs. sanitized layer · Meta-Llama-3.1-8B-Instruct (4-bit)</span>
          </div>
        </div>
      </div>
    </div>
